...
We construct an abstract interpreter for a small language which is in A-Normal Form(TODO: REF). A-Normal Form usually used as an intermediate representation of program in compiler, 
